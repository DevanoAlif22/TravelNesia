    ...
    <div class="row container-pembayaran">
        <div class="col-lg-6 p-4 d-flex" style="flex-direction:column; background-color: #1A2249;">
            ...
            <div class="align-self-center">
                <img  style="width:350px; margin-top:20px;" src="../../assets/wisata/premium.png" alt="">
            </div>
        </div>
            ...
            <div class="m-auto">
                <div class="container-bayar">
                    <div class="atas-bayar">
                        <h5 class="text-white text-center p-4">Formulir Pembayaran</h5>
                    </div>
                    <div class="bawah-bayar"></div>
                </div>
            </div>
        </div>
    </div>
