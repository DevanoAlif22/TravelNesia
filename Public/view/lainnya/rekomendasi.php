    ...
    <div class="row container-pembayaran">
        <div class="col-lg-6 p-4 d-flex" style="flex-direction:column; background-color: #1A2249;">
            <div class="container p-5 d-flex" style="flex-direction:column;">
                ...
                <h1 class="mt-4" style="color:white;"><b>Rekomendasikan wisata menarik anda</b></h1>
            ...
            <div class="align-self-center">
                <img  style="width:350px; margin-top:20px;" src="../../assets/wisata/rekomendasi.png" alt="">
            </div>
        </div>
        <div class="col-lg-6 d-flex p-4">
            <div class="m-auto">
                <div class="masukkan-data"><h4>Masukkan Data Wisata</h4></div>

                <div class="form">
                    <h5 class="pt-4"><b>Nama wisata <span style="color:red;">*</span></b></h5>
                    <input type="text" name="" id="">
                    <h5 class="pt-4"><b>Deskripsi wisata <span style="color:red;">*</span></b></h5>
                    <textarea  name="" id="" cols="42" rows="5"></textarea>
                    <h5 class="pt-4"><b>Alamat wisata <span style="color:red;">*</span></b></h5>
                    <input type="text" name="" id="">
                    <h5 class="pt-4"><b>Link google map</b></h5>
                    <input type="text" name="" id="">
                    <div class="mb-3">
                        <h5 class="pt-4"><b>Gambar wisata <span style="color:red;">*</span></b></h5>
                        <input class="form-control form-control-sm" id="formFileSm" type="file">
                    </div>
                    <button class="selesai">Kirim Rekomendasi</button>
                </div>
            </div>
        </div>
    </div>
