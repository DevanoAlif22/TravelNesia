...
<head>
    ...
    <link rel="stylesheet" href="../../css/daftar-pemandu.css">
...
<body>
    ...
    <div class="row container-pembayaran">
        ...
        <div class="col-lg-6 d-flex p-4">
            <div class="m-auto bungkus-kanan-berhasil">
                <h4>PERMINTAAN ANDA
                    DITRIMA</h4>
                <img src="../../assets/wisata/berhasil-icon.png" alt="">
                <p class="mb-4">Tunggu beberapa waktu untuk kita mengecek data </br> anda untuk kelayakan jadi pemandu
                </p>
                <div class="selesai" style="text-align: center;">
