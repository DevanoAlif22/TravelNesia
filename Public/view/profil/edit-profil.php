                    ...
                    <div class="isi-dalam">
                        ...
                        <div class="row">
                                ...
                                <div class="bungkus-kiri-up">
                                    <div class="gambar-up">
                                        <div class="profil mt-4"
                                            style="background-image: url(../../assets/profil/profil.jpg); max-width: 80px; height: 80px; ">
                            ...
                            <div class="col-lg-7">
                                ...
                                <h5 class="mb-3 mt-4" style="font-weight: 600;">Email <span style="color:red;">*</span>
                                </h5>
                                <div class="input-kanan">
                                    <input type="text">
                                </div>
                                ...
                                <div class="input-jk d-flex">
                                    <div class="jk-1">
                                        ...
                                        <input type="checkbox"><span class="ms-2">Laki-Laki</span>
                                    </div>

                                    <div class="jk-1">

                                        <input type="checkbox"><span class="ms-2">Perempuan</span>
                                    </div>
